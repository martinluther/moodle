...
$test_time_stamp = mhaairs_get_time_stamp();
...
$request_token = mhaairs_create_token($test_user_id);
$encoded_request_token = mhaairs_encode_token2($request_token, $shared_secret);
//echo "<p>request token:<b>".$request_token."</b></p>";
//echo "<p>encoded request token:<b>".$encoded_request_token."</b></p>";
echo "<p>the token is valid:<b>".(mhaairs_is_token_valid($encoded_request_token, $shared_secret)?"true":"false")."</b></p>";
